...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView=(MapView)findViewById ( R.id.bmapView );////把权限管理好（androidManifest），然后申请权限，全部通过就可以进行加载地图操作
    ...
    public class setDistrict implements BDLocationListener {
        ...
        public void onReceiveLocation(final BDLocation bdLocation) {
                ...
                if (latitude < 24.610804 && latitude > 24.608266 && longtitude > 118.086968 && longtitude < 118.091504)
                    Toast.makeText ( MainActivity.this, "在指定的教学区域内", Toast.LENGTH_LONG ).show ();
                else
                    Toast.makeText ( MainActivity.this, "不在指定的教学区域内", Toast.LENGTH_LONG ).show ();
